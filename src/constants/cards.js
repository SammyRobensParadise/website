...
export const IntensifEyeArticleCard = (
    <Wrapper>
        <A href="https://medium.com/@srobensparadise/design-ai-for-better-vision-1cac400b25ac">
            <Card
                config={{
...
export const AccessibleReactAppCard = (
    <Wrapper>
        <A href="https://medium.com/@srobensparadise/building-accessibility-into-your-react-app-f142fc786516">
            <Card
                config={{
    ...
    <Wrapper>
        <Card
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/6HhtjHZ/portfolio-winter-20-logo.png",
    ...
    <Wrapper>
        <Card
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/mDP4djv/portfolio-spring-19-logo.png",
        ...
        <A href={IllustrationsBucketURL}>
            <Card
                config={{
                    ...
                    imageURL:
                        "https://i.ibb.co/WkN8RtC/sammy-illustraions-logo.png",
    ...
    <Wrapper>
        <Card
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/tq8VpG9/github-contributions-counter-logo.png",
    ...
    <Wrapper>
        <Card
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/DChmq4z/arduino-screaming-safe-logo.png",
    ...
    <Wrapper>
        <Card
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/qDHzM8P/Junestreat-logo-junestreat-1-2x.png",
                link: "/junestreat",
    ...
    <Wrapper>
        <BannerCard
            ...
            config={{
                ...
                imageURL:
                    "https://i.ibb.co/ypgHtCr/finger-food-experience-logo.png",
