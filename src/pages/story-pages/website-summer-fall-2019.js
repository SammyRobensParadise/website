...
// section 1
const Header1 = (
    <HeaderT first>{PortfolioSummerFall2019Strings.section1.title}</HeaderT>
)
const Paragraph1 = (
    <Text>{PortfolioSummerFall2019Strings.section1.text[0]}</Text>
)
const Image1 = (
    <StoryCenterWrapper>
        <StoryImageStyle
...
// section 2
const Paragraph2 = (
    <Text>{PortfolioSummerFall2019Strings.section1.text[1]}</Text>
)
const Image2 = (
    <StoryCenterWrapper>
        <StoryImageStyle
