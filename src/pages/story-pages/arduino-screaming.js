...
const CoverChildren = (
    <>
        ...
        <SectionTitle
            ...
            story
            coverImageURL={
                "https://i.ibb.co/mBJ46gH/arduino-screaming-cover-4x.png"
            }
        />
    </>
)
...
// section 1
const Header1 = (
    <HeaderT first>{ArduinoScreamingStrings.section1.title}</HeaderT>
)
...
// section 2
const Header2 = (
    <HeaderT padding={5}>{ArduinoScreamingStrings.section2.title}</HeaderT>
)
