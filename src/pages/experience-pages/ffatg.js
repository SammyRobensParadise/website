  ...
  <Grid spacing={3}>
    <Grid item>
      ...
      <a href={FingerFoodATGURL}>
        <ActionWrapper>
          <ActionCircleButton transparent aria-label={viewFingerFood} height={'66px'}>
...
// section 2
const Header2 = <HeaderT padding={5}>{FingerFoodATGStrings.section2.title}</HeaderT>
        ...
        <Element name="about-scroller" className="element">
          ...
          <UniSection
            middleChildren={[
              <StoryCenterWrapper>
                <Button
                  onClick={() => window.open(FingerFoodATGURL, '_self')}
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') {
