...
const PolicyWriteup = (
  <PolicyText>
    <h1>Welcome tomyPrivacy Policy</h1>
    ...
    <p>
      ...
      does not apply tomycollection of information from other sources.
    </p>
    <p>
      This Privacy Policy, together with the Terms and conditions posted onmyWebsite, set forth
      the general rules and policies governing your use ofmyWebsite. Depending on your activities
      when visitingmyWebsite, you may be required to agree to additional terms and conditions.
    </p>
    <h2>Cookies</h2>
    <p>
    ...
    <p>
      By continuing to navigatemywebsite without changing your cookie settings, you hereby
